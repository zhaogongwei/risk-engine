...
export default class AddForm extends Component {
  ...
  submitHandler = ()=>{
    /*this.setState({visible:false},()=>{
      let [reportList] =[this.props.repTem.reportList]
      let newlist = []
      reportList[this.props.number]?newlist =[...reportList[this.props.number]['checkList'],...this.state.checkedList]:newlist=this.state.checkedList
      const newData = addListKey(this.deepCopy(newlist))
      reportList.splice(this.props.number,1,{...reportList[this.props.number],...{checkList:newData}})
      this.props.dispatch({
